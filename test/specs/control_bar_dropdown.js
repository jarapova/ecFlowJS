...
(async function example() {
    ...
    try {
        ...
        await driver.wait(until.elementLocated(By.xpath(ta("login","//input[@id='username']")))).sendKeys('admin');
        ...
        await driver.wait(until.elementLocated(By.css(ta('selectProject',"div.project-select-popover")))).click();
        await driver.wait(until.elementLocated(By.css(ta("EcExamplesProj","div.at-project-select-item-picker-2")))).click();
        ...
        await driver.wait(until.elementLocated(By.css(ta("apply","div.at-project-select-submit")))).click();
